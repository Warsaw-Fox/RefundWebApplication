...
namespace RefundWebApplication.Migrations
{
    ...
    [Migration("20240201194956_InitD")]
    partial class InitD
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RefundWebApplication.Models.Domain.ComplaintModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7f6397f0-3bf2-4bd3-993e-7d170e5cbdfa"),
                            City = "Sample Town",
                            Email = "jane.smith@example.com",
                            FirstName = "Jane",
                            FixDescription = "Product fix description goes here",
                            HouseNumber = "Suite 101",
                            IssueDate = new DateTime(2024, 2, 1, 20, 49, 56, 482, DateTimeKind.Local).AddTicks(7761),
                            IssueDescription = "Product issue description goes here",
                            LastName = "Smith",
                            Phone = "555-987-6543",
                            PostalCode = "54321",
                            PurchaseDate = new DateTime(2023, 11, 1, 20, 49, 56, 482, DateTimeKind.Local).AddTicks(7721),
